...
You can log in as `admin` / `Admin123!` to poke around the admin side. **Change that password** before you use this for anything beyond your own machine — the hash for it is sitting right there in the script, in a public repo.
